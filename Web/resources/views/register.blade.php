...
<div class="row">
    <div class="col" style="padding-right: 150px;padding-left: 150px;">
        <div class="border rounded-pill">
            <h2 class="display-6 text-center" style="font-family: 'Advent Pro', sans-serif;padding-top: 10px;padding-bottom: 0px;margin-bottom: 0px;">User Registration</h2>
...
<div class="row text-center d-flex align-content-center" style="margin-top: 40px;">
    <div class="col text-center d-flex justify-content-center align-items-center align-content-center align-self-center" style="padding-top: 100px;">
        ...
        <form action="" method="POST" >
            ...
            <div class="input-group" style="padding-bottom: 20px;height: 60px;"><span class="input-group-text"><i class="fa fa-user-circle-o text-muted"></i></span><input class="form-control" type="text" style="padding-left: 10px;padding-right: 10px;padding-bottom: 0px;padding-top: 0px;" placeholder="Surname" name="surname" value="{{old('surname')}}"></div>
            ...
            <div class="input-group" style="padding-bottom: 20px;height: 60px;"><span class="input-group-text"><i class="icon-envelope text-muted"></i></span><input class="form-control" type="email" placeholder="User@email.com" name="email" value="{{old('email')}}"></div>
            ...
            <button class="btn btn-outline-primary border rounded border-primary shadow-sm" type="submit" style="margin-right: 2px;width: 150px;">Register</button>
            <p style="padding-top: 15px;">Already have an account?<a href="{{'Login'}}">&nbsp;Login</a></p>
        </form>
